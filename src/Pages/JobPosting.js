...
export default function JobPosting() {
    ...
    const handleSubmit = async(e)=>{
        ...
        try {
          ...
          const res = await fetch('https://codecrushersloc50-production.up.railway.app/api/employer/postjob',{
            method:'POST',
            headers:{
              'Content-Type':'application/json',
              'Authorization':`Bearer ${token}`
            }
            ,body:JSON.stringify({company,category,domain,desc,location,salary})
          })
